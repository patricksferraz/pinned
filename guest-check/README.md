...
<br />
<p align="center">
  <a href="https://github.com/patricksferraz/guest-check">
  ...
  <p align="center">
    ...
    <br />
    <a href="https://github.com/patricksferraz/guest-check"><strong>Explore the docs »</strong></a>
    <!-- <br />
    <br />
    <a href="https://github.com/patricksferraz/guest-check">View Demo</a>
    ·
    <a href="https://github.com/patricksferraz/guest-check">Report Bug</a>
    ·
    <a href="https://github.com/patricksferraz/guest-check">Request Feature</a>-->
  </p>
</p>
...
See the [open issues](https://github.com/patricksferraz/guest-check/issues) for a list of proposed features (and known issues).
...
1. Clone the repo
   ...
   ```sh
   git clone https://github.com/patricksferraz/guest-check.git
   ```
...
Project Link: [pinned-guest-check](https://github.com/patricksferraz/guest-check)
